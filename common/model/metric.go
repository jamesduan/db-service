...
func (t *MetaStringData) String() string {
	return fmt.Sprintf("<MetaStringData Endpoint:%s, Metric:%s, Timestamp:%d, Step:%d, Value:%s, Tags:%v>",
		t.Endpoint, t.Metric, t.Timestamp, t.Step, t.Value, t.Tags)
}

func (t *MetaStringData) PK() string {
	return MUtils.PK(t.Endpoint, t.Metric, t.Tags)
}
